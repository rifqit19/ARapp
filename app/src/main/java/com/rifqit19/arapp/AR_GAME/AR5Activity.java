package com.rifqit19.arapp.AR_GAME;
...
public class AR5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton kill = findViewById(R.id.kill);
        ...
        ImageButton back = findViewById(R.id.backBtn5);
